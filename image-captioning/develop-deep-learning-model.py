...
def define_model(vocab_size, max_length):
    ...
    # summarize model
    model.summary()
    plot_model(model, to_file='img_cap_model.png', show_shapes=True)
    return model


# load training dataset (6K)
filename = '../data/Flickr8k/Flickr_8k.trainImages.txt'
...
# load test set
filename = '../data/Flickr8k/Flickr_8k.devImages.txt'
...
checkpoint = ModelCheckpoint('ddlm_model.keras', monitor='val_loss', verbose=1,
